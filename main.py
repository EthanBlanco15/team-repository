...
def venue_management(): #This function is for assigning stages with artists on a certain time for the music festival
    ...
    while True:
        ...
        if venue_verifi == "yes" and "Yes" and "YES": #As of right now, I am not sure why the "Yes" and "YES" don't work, it's probably my else statement though.
            print("Great! You should be done here now, if you haven't, try and see if all the other managements are done!")
            break
        elif venue_verifi == "no" and "No" and "NO":
...
def main():
    ...
    while True:
        ...
        if user_interface == 1:
            ...
            if last_verifi == "yes" and "Yes" and "YES":
                print("Thank you for your work today! It's time to head on home!")
                break
            if last_verifi == "no" and "No" and "NO":
